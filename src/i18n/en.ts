const en = {
  ...
  productsModal: {
    ...
    taxable: "Taxable",
    taxableOn: "Taxable",
    taxableOff: "Not taxable",
    stockTracking: "Stock Tracking",
    stockOn: "Tracking enabled",
    stockOff: "No tracking",
  ...
  timesheets: {
    ...
    colClockedOut: "Clocked Out",
    colHours: "Hours",
    colStatus: "Status",
    statusOpen: "Open",
    statusClosed: "Closed",
    totalHours: "Total Hours",
    noResults: "No time entries found.",
    loading: "Loading…",
    errorLoad: "Failed to load timesheet data.",
    viewJob: "View",
    colUser: "Worker",
    edit: "Edit",
    delete: "Delete",
    editTitle: "Edit Time Entry",
    editClockIn: "Clock In",
    editClockOut: "Clock Out",
    saveChanges: "Save Changes",
    saving: "Saving…",
    deleteConfirm: "Delete this entry?",
    confirmYes: "Yes, delete",
    confirmNo: "Cancel",
    errorEdit: "Failed to update entry.",
