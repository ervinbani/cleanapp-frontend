...
const it: Translations = {
  ...
  productCategoriesModal: {
    ...
    save: "Salva",
    update: "Aggiorna",
    required: "Il nome è obbligatorio almeno nella scheda EN.",
  },
  products: {
    title: "Prodotti",
    ...
    page: "Pagina",
    of: "di",
    stockTracked: "Tracciato",
    stockNotTracked: "Non tracciato",
  ...
  productsModal: {
    ...
    descPlaceholder: "Inserisci una descrizione...",
    sku: "SKU",
    skuPlaceholder: "es. APC-001",
    barcode: "Codice a barre",
    barcodePlaceholder: "es. 1234567890",
    category: "Categoria",
    ...
    cost: "Costo (acquisto)",
    taxable: "Imponibile",
    taxableOn: "Imponibile",
    taxableOff: "Non imponibile",
    stockTracking: "Gestione magazzino",
    stockOn: "Tracciamento attivo",
    stockOff: "Nessun tracciamento",
    stockQuantity: "Quantità",
    stockLowAlert: "Soglia scorte basse",
    status: "Stato",
    active: "Attivo",
    inactive: "Inattivo",
    cancel: "Annulla",
  ...
  timesheets: {
    ...
    colJob: "Lavoro",
    colDate: "Data",
    colClockedIn: "Entrata",
    colClockedOut: "Uscita",
    colHours: "Ore",
    colStatus: "Stato",
    statusOpen: "Aperto",
    statusClosed: "Chiuso",
    totalHours: "Ore totali",
    noResults: "Nessuna presenza trovata.",
    loading: "Caricamento…",
    errorLoad: "Errore nel caricamento delle presenze.",
    viewJob: "Vedi",
    colUser: "Operatore",
    edit: "Modifica",
    delete: "Elimina",
    editTitle: "Modifica Presenza",
    editClockIn: "Entrata",
    editClockOut: "Uscita",
    saveChanges: "Salva Modifiche",
    saving: "Salvataggio…",
    deleteConfirm: "Eliminare questa presenza?",
    confirmYes: "Sì, elimina",
    confirmNo: "Annulla",
    errorEdit: "Errore nel salvataggio.",
