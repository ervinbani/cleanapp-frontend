...
const es: Translations = {
  ...
  users: {
    ...
    colRole: "Rol",
    colStatus: "Estado",
    colEmailVerified: "Email Verificado",
  ...
  productCategoriesModal: {
    ...
    description: "Descripción",
    descPlaceholder: "Ingresa una descripción...",
    color: "Color (hex)",
    ...
    save: "Guardar",
    update: "Actualizar",
    required: "El nombre es obligatorio al menos en la pestaña EN.",
  },
  products: {
    title: "Productos",
  ...
  productsModal: {
    ...
    descPlaceholder: "Ingresa una descripción...",
    sku: "SKU",
    skuPlaceholder: "ej. APC-001",
    barcode: "Código de barras",
    barcodePlaceholder: "ej. 1234567890",
    category: "Categoría",
    ...
    taxable: "Gravable",
    taxableOn: "Gravable",
    taxableOff: "No gravable",
    stockTracking: "Seguimiento de stock",
    stockOn: "Seguimiento activado",
    stockOff: "Sin seguimiento",
    stockQuantity: "Cantidad",
    stockLowAlert: "Alerta stock bajo",
    status: "Estado",
    active: "Activo",
    inactive: "Inactivo",
    cancel: "Cancelar",
  ...
  timesheets: {
    ...
    colJob: "Trabajo",
    colDate: "Fecha",
    colClockedIn: "Entrada",
    colClockedOut: "Salida",
    colHours: "Horas",
    colStatus: "Estado",
    statusOpen: "Abierto",
    statusClosed: "Cerrado",
    totalHours: "Total horas",
    noResults: "No se encontraron registros de tiempo.",
    loading: "Cargando…",
    errorLoad: "Error al cargar los datos de presencia.",
    viewJob: "Ver",
    colUser: "Trabajador",
    edit: "Editar",
    delete: "Eliminar",
    ...
    confirmNo: "Cancelar",
    errorEdit: "Error al guardar el registro.",
